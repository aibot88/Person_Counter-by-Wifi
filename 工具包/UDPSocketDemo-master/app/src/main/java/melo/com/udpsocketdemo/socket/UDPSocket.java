...
public class UDPSocket {
    ...
    private static final String BROADCAST_IP = "202.117.15.140";

    // 端口号，飞鸽协议默认端口2425
    public static final int CLIENT_PORT = 8801;
    ...
    private static final double HEARTBEAT_MESSAGE_DURATION = 0.01 * 1000;
...
//                while (true) {//若超过十秒他没收到我的心跳包，则重新发一个。不发心跳包
...
//                        e.printStackTrace(); }
//                    sendMessage(string);
//                    if((lastReceiveTime - System.currentTimeMillis()) > TIME_OUT)
//                        break;
//                }
            }
